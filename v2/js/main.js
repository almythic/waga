...
(function () {
  ...
  function loadComponent(el, url) {
    return fetch(url)
      ...
      .then(function (html) {
        // Use a temporary div to parse the HTML string. This approach is often more
        // resilient than DOMParser when dealing with injected scripts from 
        // development tools (like Live Server or VS Code Live Preview).
        var tempDiv = document.createElement('div');
        tempDiv.innerHTML = html;

        // Clean up any injected scripts to prevent execution or layout issues
  ...
  function init() {
    ...
    if (scrubVideo && scrubSection) {
      ...
      // On mobile: skip scroll scrub entirely — content shows immediately,
      // section height is left at auto (CSS handles layout).
